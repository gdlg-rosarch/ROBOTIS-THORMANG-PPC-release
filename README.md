...
## ROS Packages for ROBOTIS THORMANG3 PPC
|Version|Kinetic + Ubuntu Xenial|Melodic + Ubuntu Bionic|
|:---:|:---:|:---:|
|[![GitHub version](https://badge.fury.io/gh/ROBOTIS-GIT%2FROBOTIS-THORMANG-PPC.svg)](https://badge.fury.io/gh/ROBOTIS-GIT%2FROBOTIS-THORMANG-PPC)|[![Build Status](https://travis-ci.org/ROBOTIS-GIT/ROBOTIS-THORMANG-PPC.svg?branch=kinetic-devel)](https://travis-ci.org/ROBOTIS-GIT/ROBOTIS-THORMANG-PPC)|-|
...
## Wiki for thormang3_ppc Packages
- http://wiki.ros.org/thormang3_ppc (metapackage)
- http://wiki.ros.org/thormang3_sensors
- http://wiki.ros.org/thormang3_manipulation_demo
- http://wiki.ros.org/thormang3_walking_demo
